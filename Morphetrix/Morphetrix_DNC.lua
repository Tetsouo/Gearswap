...
local UIConfig = ConfigLoader.load_ui_config('Morphetrix', 'DNC')
...
function get_sets()
    ...
    _G.DNCTPConfig = require('Morphetrix/config/dnc/DNC_TP_CONFIG')
    _G.DNCWSConfig = require('Morphetrix/config/dnc/DNC_WS_CONFIG')
...
function user_setup()
    ...
    local DNCStates = require('Morphetrix/config/dnc/DNC_STATES')
    DNCStates.configure()
    ...
    if is_initial_setup then
        ...
        local success, keybinds = pcall(require, 'Morphetrix/config/dnc/DNC_KEYBINDS')
