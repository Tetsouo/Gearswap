...
local UIConfig = ConfigLoader.load_ui_config('Morphetrix', 'WHM')
...
function get_sets()
    ...
    _G.WHMTPConfig = require('Morphetrix/config/whm/WHM_TP_CONFIG')
...
function user_setup()
    ...
    local WHMStates = require('Morphetrix/config/whm/WHM_STATES')
    WHMStates.configure()
    ...
    if is_initial_setup then
        -- Load keybinds
        local success, keybinds = pcall(require, 'Morphetrix/config/whm/WHM_KEYBINDS')
