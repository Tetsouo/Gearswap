...
local lockstyle_config_success, LockstyleConfig = pcall(require, 'Morphetrix/config/LOCKSTYLE_CONFIG')
...
local ui_config_success, UIConfig = pcall(require, 'Morphetrix/config/UI_CONFIG')
...
local UIConfig = ConfigLoader.load_ui_config('Morphetrix', 'BRD')
...
function get_sets()
    ...
    _G.BRDTPConfig = require('Morphetrix/config/brd/BRD_TP_CONFIG')
    _G.BRDSongConfig = require('Morphetrix/config/brd/BRD_SONG_CONFIG')
    _G.BRDTimingConfig = require('Morphetrix/config/brd/BRD_TIMING_CONFIG')
...
function user_setup()
    ...
    local BRDStates = require('Morphetrix/config/brd/BRD_STATES')
    BRDStates.configure()

    if is_initial_setup then
        -- KEYBIND LOADING
        local success, keybinds = pcall(require, 'Morphetrix/config/brd/BRD_KEYBINDS')
