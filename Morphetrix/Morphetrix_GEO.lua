...
local UIConfig = ConfigLoader.load_ui_config('Morphetrix', 'GEO')
...
function get_sets()
    ...
    _G.GEOTPCONFIG = require('Morphetrix/config/geo/GEO_TP_CONFIG')
...
function user_setup()
    ...
    local GEOStates = require('Morphetrix/config/geo/GEO_STATES')
    GEOStates.configure()
    ...
    if is_initial_setup then
        ...
        -- KEYBIND LOADING
        local success, keybinds = pcall(require, 'Morphetrix/config/geo/GEO_KEYBINDS')
