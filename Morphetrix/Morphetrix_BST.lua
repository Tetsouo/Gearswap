...
local UIConfig = ConfigLoader.load_ui_config('Morphetrix', 'BST')
...
function get_sets()
    ...
    _G.BSTBeastPetData = require('Morphetrix/config/bst/BST_PET_DATA')
    _G.BSTTPConfig = require('Morphetrix/config/bst/BST_TP_CONFIG')
...
function user_setup()
    ...
    -- ==========================================================================
    local BSTStates = require('Morphetrix/config/bst/BST_STATES')
    BSTStates.configure()
    ...
    -- KEYBINDS LOADING
    -- ==========================================================================
    local kb_success, keybinds = pcall(require, 'Morphetrix/config/bst/BST_KEYBINDS')
