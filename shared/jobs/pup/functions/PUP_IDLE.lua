...
local success_sb, SetBuilder = pcall(require, 'shared/jobs/pup/functions/logic/set_builder')
if not success_sb then
    MessageFormatter.error_pup_module_not_loaded('SetBuilder')
    SetBuilder = nil
end
...
--- Simplified logic following PUP_OLD_BACKUP pattern
---
...
function customize_idle_set(idleSet)
    ...
    if pet_valid then
        ...
        -- Use .value (not .current) like old PUP system
