---============================================================================
--- PLD Buff Management Module - Buff Change Handling & Automation
---============================================================================
--- Handles Paladin buff events and automatic gear adjustments:
...
---
--- @file    jobs/pld/functions/PLD_BUFFS.lua
--- @author  Tetsouo
--- @version 1.0.0
