---============================================================================
--- AOE Manager - Blue Magic AOE Spell Rotation (PLD/BLU)
---============================================================================
--- Manages AOE Blue Magic spell casting for PLD/BLU subjob combination.
...
function AOEManager.execute_aoe()
    ...
    if unknown_spells == #AOE_SPELLS then
        MessageFormatter.show_error('No Blue Magic AOE spells equipped! (Need PLD/BLU subjob)')
