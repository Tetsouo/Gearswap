---============================================================================
--- SAM Lockstyle Module - Lockstyle Management (Factory Pattern)
---============================================================================
--- Handles lockstyle selection and management for SAM job.
...
---
--- @file    jobs/sam/functions/SAM_LOCKSTYLE.lua
--- @author  Tetsouo
...
-- Export cancel_sam_lockstyle_operations() to global scope
function cancel_sam_lockstyle_operations()
    return get_lockstyle_module().cancel_sam_lockstyle_operations()
end

_G.select_default_lockstyle = select_default_lockstyle
_G.cancel_sam_lockstyle_operations = cancel_sam_lockstyle_operations
