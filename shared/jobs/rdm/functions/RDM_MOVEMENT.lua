---============================================================================
--- RDM Movement Management Module
---============================================================================
--- Handles movement-based gear management for Red Mage.
--- Uses centralized AutoMove position tracking for performance.
---
--- @file jobs/rdm/functions/RDM_MOVEMENT.lua
--- @author Tetsouo
--- @version 1.0
...
function get_rdm_movement_status()
...
function job_handle_equipping_gear(playerStatus, eventArgs)
    ...
    -- This function can be used for additional RDM-specific gear logic
end
...
-- Export module
local RDM_MOVEMENT = {}
RDM_MOVEMENT.job_handle_equipping_gear = job_handle_equipping_gear
RDM_MOVEMENT.get_rdm_movement_status = get_rdm_movement_status
