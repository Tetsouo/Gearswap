---============================================================================
--- BST Job Ability Database - Legacy Wrapper
---============================================================================
...
local subjob_success, subjob_module = pcall(require, 'shared/data/job_abilities/bst/bst_subjob')
...
local mainjob_success, mainjob_module = pcall(require, 'shared/data/job_abilities/bst/bst_mainjob')
