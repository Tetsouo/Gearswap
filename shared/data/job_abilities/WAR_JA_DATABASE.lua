---============================================================================
--- WAR Job Ability Database - Legacy Wrapper
---============================================================================
...
local subjob_success, subjob_module = pcall(require, 'shared/data/job_abilities/war/war_subjob')
...
local mainjob_success, mainjob_module = pcall(require, 'shared/data/job_abilities/war/war_mainjob')
...
-- Load SP abilities
local sp_success, sp_module = pcall(require, 'shared/data/job_abilities/war/war_sp')
