...
ENHANCING_UTILITY.spells = {
    ...
    ["Adloquium"] = {
        description = "Increases maximum HP, magic defense, and reduces spell interruption rate.",
    ...
    ["Klimaform"] = {
        description = "Enhances elemental magic potency when matching weather is active.",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "single",
        element = "Dark",
    ...
    ["Boost-INT"] = {
        description = "Increases Intelligence for party members within area of effect.",
        skill = "Enhancing Magic",
        spell_family = "Boost",
        target_type = "aoe",
        element = "Ice",
    ...
    ["Recall-Jugner"] = {
        description = "Transports party members to their homepoint in Jugner Forest [S].",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "aoe",
        element = "Light",
    ...
    ["Recall-Meriph"] = {
        description = "Transports party members to their homepoint in Meriphataud Mountains [S].",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "aoe",
        element = "Light",
    ...
    ["Recall-Pashh"] = {
        description = "Transports party members to their homepoint in Pashhow Marshlands [S].",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "aoe",
        element = "Light",
    ...
    ["Escape"] = {
        description = "Transports party to the entrance of current dungeon.",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "aoe",
        element = "Dark",
    ...
    ["Teleport-Altep"] = {
        description = "Transports party members to Crag of Holla (Western Altepa Desert).",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "aoe",
        element = "Light",
    ...
    ["Teleport-Dem"] = {
        description = "Transports party members to Crag of Dem (Konschtat Highlands).",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "aoe",
        element = "Light",
    ...
    ["Teleport-Holla"] = {
        description = "Transports party members to Crag of Holla (La Theine Plateau).",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "aoe",
        element = "Light",
    ...
    ["Teleport-Mea"] = {
        description = "Transports party members to Crag of Mea (Tahrongi Canyon).",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "aoe",
        element = "Light",
    ...
    ["Teleport-Vahzl"] = {
        description = "Transports party members to Crag of Vahzl (Xarcabard).",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "aoe",
        element = "Light",
    ...
    ["Teleport-Yhoat"] = {
        description = "Transports party members to Crag of Yhoat (Yhoator Jungle).",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "aoe",
        element = "Light",
    ...
    ["Warp II"] = {
        description = "Returns party leader to their Home Point, and party members to yours.",
        skill = "Enhancing Magic",
        spell_family = nil,
        target_type = "single",
        tier = "II",
