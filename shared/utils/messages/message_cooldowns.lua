---============================================================================
--- Message Cooldowns - Professional cooldown and recast timing messages
---============================================================================
--- @file utils/message_cooldowns.lua
--- @author Tetsouo
--- @version 2.1
...
function MessageCooldowns.show_cooldown_message(job_name, action_type, name, remaining, status, no_separators)
    ...
    add_to_chat(1, final_message) -- White base color, inline colors handle the rest
...
function MessageCooldowns.show_multi_status(messages, job_name)
    ...
    for _, msg in ipairs(messages) do
        ...
        add_to_chat(1, table.concat(message_parts))
    end
