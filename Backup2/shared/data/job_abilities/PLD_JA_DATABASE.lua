---============================================================================
--- PLD Job Ability Database - Legacy Wrapper
---============================================================================
...
local subjob_success, subjob_module = pcall(require, 'shared/data/job_abilities/pld/pld_subjob')
...
local mainjob_success, mainjob_module = pcall(require, 'shared/data/job_abilities/pld/pld_mainjob')
...
-- Load SP abilities
local sp_success, sp_module = pcall(require, 'shared/data/job_abilities/pld/pld_sp')
