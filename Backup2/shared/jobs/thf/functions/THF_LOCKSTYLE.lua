...
---============================================================================
--- Handles lockstyle selection and management for THF job.
...
-- Export cancel_thf_lockstyle_operations() to global scope
function cancel_thf_lockstyle_operations()
    return get_lockstyle_module().cancel_thf_lockstyle_operations()
end

_G.select_default_lockstyle = select_default_lockstyle
_G.cancel_thf_lockstyle_operations = cancel_thf_lockstyle_operations
