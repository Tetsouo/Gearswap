...
---============================================================================
--- Handles lockstyle selection and management for PLD job.
...
-- Export cancel_pld_lockstyle_operations() to global scope
function cancel_pld_lockstyle_operations()
    return get_lockstyle_module().cancel_pld_lockstyle_operations()
end

_G.select_default_lockstyle = select_default_lockstyle
_G.cancel_pld_lockstyle_operations = cancel_pld_lockstyle_operations
