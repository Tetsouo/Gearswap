...
---============================================================================
--- Handles lockstyle selection and management for BST job.
...
-- Export cancel_bst_lockstyle_operations() to global scope
function cancel_bst_lockstyle_operations()
    return get_lockstyle_module().cancel_bst_lockstyle_operations()
end

_G.select_default_lockstyle = select_default_lockstyle
_G.cancel_bst_lockstyle_operations = cancel_bst_lockstyle_operations
