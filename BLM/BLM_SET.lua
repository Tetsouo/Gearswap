...
sets.precast.WS = {
    ...
    left_ear = createEquipment('Moonshade Earring', 'Accuracy+4', 'TP Bonus +250'),
...
sets.midcast.Cure = {
    ...
    head = createEquipment('C. Palug Crown'),
    body = createEquipment('Nyame Mail'),
    hands = createEquipment('Telchine Gloves', 'Enh. Mag. eff. dur. +10'),
    legs = createEquipment('Nyame Flanchard'),
    feet = createEquipment("Medium's Sabots", 'MP+50', 'MND+10', '"Conserve MP"+7', '"Cure" potency +5%'),
    neck = createEquipment('Loricate Torque +1'),
    waist = createEquipment('Plat. Mog. Belt'),
    left_ear = createEquipment('Impreg. Earring'),
    right_ear = createEquipment('Wicce Earring +1', 'System: 1 ID: 1676 Val: 0', 'Mag. Acc.+14', 'Enmity-4'),
    left_ring = createEquipment('Defending Ring'),
    right_ring = createEquipment('Freke Ring'),
    back = createEquipment("Taranus's Cape"),
}
...
sets.midcast.Aquaveil = {
    ...
    legs = createEquipment("Telchine Braconi", nil, nil, { 'Enh. Mag. eff. dur. +10' }),
    feet = createEquipment("Telchine Pigaches", nil, nil, { 'Enh. Mag. eff. dur. +10' }),
    neck = createEquipment("Loricate Torque +1", nil, nil),
    waist = createEquipment("Olympus Sash"),
    left_ear = createEquipment("Andoaa Earring"),
    right_ear = createEquipment("Lugalbanda Earring"),
    left_ring = createEquipment("Stikini Ring +1"),
    right_ring = createEquipment("Evanescence Ring"),
    back = createEquipment("Fi Follet Cape +1", nil, nil),
}
...
sets.midcast.MndEnfeebles = {
    main = createEquipment('Contemplator +1'),
    sub = createEquipment('Khonsu'),
    ammo = createEquipment('Quartz Tathlum +1'),
    head = createEquipment('Befouled Crown'),
    neck = createEquipment("Incanter's Torque"),
    ear1 = createEquipment('Vor Earring'),
    ear2 = createEquipment('Regal Earring'),
    body = createEquipment("Spaekona's Coat +3"),
    hands = createEquipment('Regal Cuffs'),
    left_ring = StikiRing1,
    right_ring = StikiRing2,
    back = createEquipment("Aurist's Cape +1"),
    waist = createEquipment('Rumination sash'),
    legs = createEquipment('Psycloth Lappas', 15),
    feet = createEquipment('Skaoi boots', 14)
}
sets.midcast.IntEnfeebles = sets.midcast.MndEnfeebles
sets.midcast.Breakga = {
    main = createEquipment("Bunzi's Rod"),
    sub = createEquipment("Ammurapi Shield"),
    ammo = createEquipment("Ghastly Tathlum +1", nil, nil),
    head = createEquipment("Wicce Petasos +3"),
    body = createEquipment("Wicce Coat +3"),
    hands = createEquipment("Wicce Gloves +3"),
    legs = createEquipment("Wicce Chausses +3"),
    feet = createEquipment("Wicce Sabots +3"),
    neck = createEquipment("Src. Stole +2", nil, nil),
    waist = createEquipment("Acuity Belt +1", nil, nil),
    left_ear = createEquipment("Malignance Earring"),
    right_ear = createEquipment("Wicce Earring +1", nil, nil),
    left_ring = createEquipment("Metamor. Ring +1", nil, nil),
    right_ring = createEquipment("Stikini Ring +1"),
    back = createEquipment("Taranus's cape")
}
...
sets.midcast['Elemental Magic'] = {
    ...
    right_ring = createEquipment("Metamor. Ring +1", nil, nil),
    back = createEquipment("Taranus's cape")
}
sets.midcast['Elemental Magic'].MagicBurst = {
    main = createEquipment("Bunzi's rod"),
    sub = createEquipment('Ammurapi Shield'),
    ammo = createEquipment('Ghastly tathlum'),
    head = createEquipment("Wicce Petasos +3"),
    body = createEquipment("Wicce Coat +3"),
    hands = createEquipment("Wicce Gloves +3"),
    legs = createEquipment("Wicce Chausses +3"),
...
sets.engaged = {
    main = createEquipment("Malignance Pole"),
    sub = createEquipment("Enki Strap"),
    ammo = createEquipment("Ghastly Tathlum +1", nil, nil, { 'Path: A', }),
    head = createEquipment("Wicce Petasos +3"),
    body = createEquipment("Wicce Coat +3"),
    hands = createEquipment("Wicce Gloves +3"),
    legs = createEquipment("Wicce Chausses +3"),
