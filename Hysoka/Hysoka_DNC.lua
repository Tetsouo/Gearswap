...
local UIConfig = ConfigLoader.load_ui_config('Hysoka', 'DNC')
...
function get_sets()
    ...
    _G.DNCTPConfig = require('Hysoka/config/dnc/DNC_TP_CONFIG')
    _G.DNCWSConfig = require('Hysoka/config/dnc/DNC_WS_CONFIG')
...
function user_setup()
    ...
    local DNCStates = require('Hysoka/config/dnc/DNC_STATES')
    DNCStates.configure()
    ...
    if is_initial_setup then
        ...
        local success, keybinds = pcall(require, 'Hysoka/config/dnc/DNC_KEYBINDS')
