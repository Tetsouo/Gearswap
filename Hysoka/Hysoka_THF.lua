...
local UIConfig = ConfigLoader.load_ui_config('Hysoka', 'THF')
...
function get_sets()
    ...
    _G.THFTPCONFIG = require('Hysoka/config/thf/THF_TP_CONFIG')
...
function user_setup()
    ...
    local THFStates = require('Hysoka/config/thf/THF_STATES')
    THFStates.configure()
    ...
    if is_initial_setup then
        ...
        local success, keybinds = pcall(require, 'Hysoka/config/thf/THF_KEYBINDS')
