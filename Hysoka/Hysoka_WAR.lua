...
local _, UIConfig = pcall(require, 'Hysoka/config/UI_CONFIG')
UIConfig = UIConfig or {
    init_delay = 5.0
}

-- Load region configuration (must load before message system for color codes)
local _, RegionConfig = pcall(require, 'Hysoka/config/REGION_CONFIG')
...
local UIConfig = ConfigLoader.load_ui_config('Hysoka', 'WAR')
...
function get_sets()
    ...
    _G.WARTPConfig = require('Hysoka/config/war/WAR_TP_CONFIG')
...
function user_setup()
    ...
    -- ==========================================================================
    local WARStates = require('Hysoka/config/war/WAR_STATES')
    WARStates.configure()
    ...
    -- KEYBINDS LOADING
    -- ==========================================================================
    local kb_success, keybinds = pcall(require, 'Hysoka/config/war/WAR_KEYBINDS')
