...
local UIConfig = ConfigLoader.load_ui_config('Hysoka', 'PUP')
...
function get_sets()
    ...
    _G.PUPBeastPetData = require('Hysoka/config/pup/PUP_PET_DATA')
    _G.PUPTPConfig = require('Hysoka/config/pup/PUP_TP_CONFIG')
...
function user_setup()
    ...
    -- ==========================================================================
    local PUPStates = require('Hysoka/config/pup/PUP_STATES')
    PUPStates.configure()
    ...
    -- KEYBINDS LOADING
    -- ==========================================================================
    local kb_success, keybinds = pcall(require, 'Hysoka/config/pup/PUP_KEYBINDS')
