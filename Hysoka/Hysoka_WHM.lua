...
local UIConfig = ConfigLoader.load_ui_config('Hysoka', 'WHM')
...
function get_sets()
    ...
    _G.WHMTPConfig = require('Hysoka/config/whm/WHM_TP_CONFIG')
...
function user_setup()
    ...
    local WHMStates = require('Hysoka/config/whm/WHM_STATES')
    WHMStates.configure()
    ...
    if is_initial_setup then
        -- Load keybinds
        local success, keybinds = pcall(require, 'Hysoka/config/whm/WHM_KEYBINDS')
