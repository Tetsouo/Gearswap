...
local UIConfig = ConfigLoader.load_ui_config('Hysoka', 'GEO')
...
function get_sets()
    ...
    _G.GEOTPCONFIG = require('Hysoka/config/geo/GEO_TP_CONFIG')
...
function user_setup()
    ...
    local GEOStates = require('Hysoka/config/geo/GEO_STATES')
    GEOStates.configure()
    ...
    if is_initial_setup then
        ...
        -- KEYBIND LOADING
        local success, keybinds = pcall(require, 'Hysoka/config/geo/GEO_KEYBINDS')
