...
SouvHead = EquipmentFactory.create("Souv. Schaller +1", 24, nil, {
    "HP+105",
    "Enmity+9",
    'Potency of "Cure" effect received +15%'
})
SouvBody = EquipmentFactory.create("Souv. Cuirass +1", 3, nil, {
    "HP+105",
    "Enmity+9",
    'Potency of "Cure" effect received +15%'
})
SouvHands = EquipmentFactory.create("Souv. Handsch. +1", 23, nil, {
    "HP+105",
    "Enmity+9",
    'Potency of "Cure" effect received +15%'
})
SouvLegs = EquipmentFactory.create("Souv. Diechlings +1", 16, nil, {
    "HP+105",
    "Enmity+9",
    'Potency of "Cure" effect received +15%'
})
SouvFeet = EquipmentFactory.create("Souveran Schuhs +1", 22, nil, {
    "HP+105",
    "Enmity+9",
    'Potency of "Cure" effect received +15%'
})
...
-- Valorous Hose
ValorousHose = EquipmentFactory.create("Valorous Hose", nil, nil, {
    "Store TP +2",
    "Accuracy+17",
...
Cichol = {
    stp = EquipmentFactory.create("Cichol's Mantle", nil, nil, {
        "STR+20",
    ...
    ws1 = EquipmentFactory.create("Cichol's Mantle", nil, nil, {
        "STR+20",
        "Accuracy+20 Attack+20",
        "STR+10",
...
-- Equipment validation re-enabled with performance monitoring
-- All sets are functional in-game with validation

-- Simple job loading notification
local success, validation = pcall(function()
    -- Silent validation of critical sets
    local validation_errors = 0

    -- Check essential sets exist
    if not (sets.idle and sets.engaged and sets.precast) then
    ...
    JobLoader.show_loaded_message("WAR", validation_errors == 0)
...
if not success then
    ...
    local messages = { { type = 'error', name = 'Validation', message = 'Failed to load: ' .. tostring(validation) } }
