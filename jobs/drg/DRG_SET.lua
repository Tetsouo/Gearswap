...
sets['Trishula'] = { main = createEquipment('Trishula'), sub = createEquipment('Utu Grip') }
sets['Shining One'] = { main = createEquipment('Shining One'), sub = createEquipment('Utu Grip') }
sets['Ryunohige'] = { main = createEquipment('Ryunohige'), sub = createEquipment('Utu Grip') }
sets['Gungnir'] = { main = createEquipment('Gungnir'), sub = createEquipment('Utu Grip') }

sets['Utu Grip'] = { sub = createEquipment('Utu Grip') }
sets['Hagneia Stone'] = { ammo = createEquipment('Hagneia Stone') }
