...
local RINGS                            = {
    MoonLight1 = EquipmentFactory.create("Moonlight Ring", nil, "wardrobe 2"),
    MoonLight2 = EquipmentFactory.create("Moonlight Ring", nil, "wardrobe 3"),
    Chirich1 = EquipmentFactory.create("Chirich Ring +1", nil, "wardrobe 1"),
    Chirich2 = EquipmentFactory.create("Chirich Ring +1", nil, "wardrobe 2"),
    Stikini1 = EquipmentFactory.create("Stikini Ring +1", nil, "wardrobe 6"),
    Stikini2 = EquipmentFactory.create("Stikini Ring +1", nil, "wardrobe 7"),
    Varar2 = EquipmentFactory.create("Varar Ring +1", nil, "wardrobe 7"),
...
Artio                                  = {
    STP = EquipmentFactory.create("Artio's Mantle", nil, nil, {
        "DEX+20", "Accuracy+20 Attack+20", "Accuracy+10", '"Store TP"+10', "Damage taken-5%"
    }),
    WS1 = EquipmentFactory.create("Artio's Mantle", nil, nil, {
        "STR+20", "Accuracy+20 Attack+20", "STR+10", "Weapon skill damage +10%", "Damage taken-5%"
    }),
    PETSTP = EquipmentFactory.create("Artio's Mantle", nil, nil, {
    ...
    PETMB = EquipmentFactory.create("Artio's Mantle", nil, nil, {
...
Pastoralist                            = {
    petDT = EquipmentFactory.create("Pastoralist's Mantle", nil, nil, {
        "STR+3 DEX+3", "Pet: Accuracy+18 Pet: Rng. Acc.+18", "Pet: Damage taken -4%"
    })
}

-- Additional reusable gear
JumalikHead                            = EquipmentFactory.create("Jumalik Helm", nil, nil, {
    "MND+10", '"Mag.Atk.Bns."+15', "Magic burst dmg.+10%", '"Refresh"+1'
})

JumalikBody                            = EquipmentFactory.create("Jumalik Mail", nil, nil, {
...
sets["Aymur"]                          = { main = EquipmentFactory.create("Aymur") }
sets["Agwu's axe"]                     = { sub = EquipmentFactory.create("Agwu's Axe") }
sets["Tauret"]                         = { main = EquipmentFactory.create("Tauret") }
sets["Blur Knife"]                     = { sub = EquipmentFactory.create("Blurred Knife +1") }
sets["Adapa"]                          = { sub = EquipmentFactory.create("Adapa Shield") }
sets["Diamond Aspis"]                  = { sub = EquipmentFactory.create("Diamond Aspis") }
-- Define ammo sets
sets["Amiable Roche (Fish)"]           = { ammo = EquipmentFactory.create("Airy Broth") }
sets["Jovial Edwin (Crab)"]            = { ammo = EquipmentFactory.create("Pungent Broth") }
sets["Fluffy Bredo (Acuex)"]           = { ammo = EquipmentFactory.create("Venomous Broth") }
sets["Sultry Patrice (Slime)"]         = { ammo = EquipmentFactory.create("Putrescent Broth") }
sets["Fatso Fargann (Leech)"]          = { ammo = EquipmentFactory.create("C. Plasma Broth") }
sets["Generous Arthur (Slug)"]         = { ammo = EquipmentFactory.create("Dire Broth") }
sets["Blackbeard Randy (Tiger)"]       = { ammo = EquipmentFactory.create("Meaty Broth") }
sets["Rhyming Shizuna (Sheep)"]        = { ammo = EquipmentFactory.create("Lyrical Broth") }
sets["Pondering Peter (Rabbit)"]       = { ammo = EquipmentFactory.create("Vis. Broth") }
sets["Vivacious Vickie (Raaz)"]        = { ammo = EquipmentFactory.create("Tant. Broth") }
sets["Choral Leera (Colibri)"]         = { ammo = EquipmentFactory.create("Glazed Broth") }
sets["Daring Roland (Hippogryph)"]     = { ammo = EquipmentFactory.create("Feculent Broth") }
sets["Swooping Zhivago (Tulfaire)"]    = { ammo = EquipmentFactory.create("Windy Greens") }
sets["Warlike Patrick (Lizard)"]       = { ammo = EquipmentFactory.create("Livid Broth") }
sets["Suspicious Alice (Eft)"]         = { ammo = EquipmentFactory.create("Furious Broth") }
sets["Brainy Waluis (Funguar)"]        = { ammo = EquipmentFactory.create("Crumbly Soil") }
sets["Sweet Caroline (Mandragora)"]    = { ammo = EquipmentFactory.create("Aged Humus") }
sets["Bouncing Bertha (Chapuli)"]      = { ammo = EquipmentFactory.create("Bubbly Broth") }
sets["Threestar Lynn (Ladybug)"]       = { ammo = EquipmentFactory.create("Muddy Broth") }
sets["Headbreaker Ken (Fly)"]          = { ammo = EquipmentFactory.create("Blackwater Broth") }
sets["Energized Sefina (Beetle)"]      = { ammo = EquipmentFactory.create("Gassy Sap") }
sets["Anklebiter Jedd (Diremite)"]     = { ammo = EquipmentFactory.create("Crackling Broth") }
sets["Left-Handed Yoko (Mosquito)"]    = { ammo = EquipmentFactory.create("Heavenly Broth") }
sets["Cursed Annabelle (Antlion)"]     = { ammo = EquipmentFactory.create("Creepy Broth") }
sets["Weevil Familiar (Weevil)"]       = { ammo = EquipmentFactory.create("T. Pristine Sap") }
...
local petDTCore                        = {
    head = EquipmentFactory.create("Anwig Salade", nil, nil, {
        "CHR+4", '"Waltz" ability delay -2', "Attack+3", "Pet: Damage taken -10%"
    }),
    body = "Tot. Jackcoat +3",
    hands = EquipmentFactory.create("Ankusa Gloves +3", nil, nil, {
...
JobLoader.show_loaded_message("BST")
