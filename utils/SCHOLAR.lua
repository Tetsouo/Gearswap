...
function ScholarUtils.get_available_stratagem_count()
    ...
    local success_ChargesUtils, ChargesUtils = pcall(require, 'utils/ABILITY_CHARGES')
    if not success_ChargesUtils then
        error("Failed to load utils/ability_charges: " .. tostring(ChargesUtils))
    end
