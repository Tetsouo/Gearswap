...
if not success or not UIConfig then
    ...
    add_to_chat(167, "[WAR] UIConfig load failed, using defaults")
else
end
...
function get_sets()
    ...
    _G.WARTPConfig = require('Typioni/config/war/WAR_TP_CONFIG')
    ...
    -- Load dependencies (order matters: AutoMove before WAR_MOVEMENT)
...
function user_setup()
    ...
    -- ==========================================================================
    local WARStates = require('Typioni/config/war/WAR_STATES')
    WARStates.configure()
    ...
    -- KEYBINDS LOADING
    -- ==========================================================================
    local kb_success, keybinds = pcall(require, 'Typioni/config/war/WAR_KEYBINDS')
