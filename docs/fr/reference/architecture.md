...
local module = SafeLoader.require('path/module')  -- Ne crash pas si manquant
```

### Equipment Factory

Création standardisée d'équipement :
...
Cette architecture modulaire permet une extension facile tout en maintenant la stabilité du système principal.
