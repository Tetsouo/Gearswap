...
```bash
//gs c perf start           # Démarrer monitoring
//gs c perf stop            # Arrêter monitoring
//gs c perf report          # Afficher rapport
```

### Métriques Importantes

- **Utilisation mémoire** : <100MB normal
- **Changements équipement** : <100ms par changement
- **Commandes dual-boxing** : <200ms latence

## 🚀 Optimisations Pratiques

### Réduire Lag Équipement

```lua
-- Éviter changements équipement répétés
local last_gear_set = {}
