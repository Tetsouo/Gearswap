# Red Mage (RDM) - GearSwap System Documentation
...
**First time using RDM?** → Start with [Quick Start](quick-start.md)
...
**Keybinds**: 32 total (27 Alt/F-keys, 10 Ctrl)
**States**: 20 configurable modes
**Commands**: 25+ available
**Special Features**:

- Auto-Saboteur before enfeebles
- Light/Dark elemental spell management
- Enspell automation
- Dualwield support (NIN subjob)
- Bar spell rotation (Element + Ailment)
