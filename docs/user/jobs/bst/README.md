# Beastmaster (BST) - GearSwap System Documentation
...
**First time using BST?** >> Start with [Quick Start](quick-start.md)
...
**Keybinds**: 11 total
**States**: 0 configurable modes
**Commands**: 11+ available
**Special Features**:

- Standard job features
