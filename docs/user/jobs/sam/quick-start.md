...
3. **Verify loading**:
 - Look for: `[SAM] Functions loaded successfully`
 - Keybinds auto-loaded
 - Macrobook set to Book 2, Page 1
 - Lockstyle #2 applied after 8 seconds
...
```
>> Console shows: "SAM SYSTEM LOADED"
```
