# BRD - Quick Start Guide

## 🚀 Loading the System

1. **Change to BRD in-game**
2. **Load GearSwap**:
...
3. **Verify loading**:
   - Look for: `[BRD] Functions loaded successfully`
   - Keybinds auto-loaded
   - Macrobook set to Book 36, Page 1
   - Lockstyle #7 applied after 8 seconds
...
```
>> Console shows: "BRD SYSTEM LOADED"
```
...
- ✅ Loads all BRD keybinds (23 total)
- ✅ Sets macrobook (Book 36, Page 1 for WHM)
- ✅ Applies lockstyle #7 (after 8s delay)
