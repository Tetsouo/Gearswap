...
sets.latent_refresh = {
    ...
    left_ring = createEquipment('Stikini Ring +1', 0, 'wardrobe 5'),
    right_ring = createEquipment('Stikini Ring +1', 0, 'wardrobe 6'),
    back = Rudianos.tank,
...
sets.midcast.SIRDEnmity = {
    ...
    left_ring = createEquipment("Apeile ring +1"),
    right_ring = createEquipment('Gelatinous Ring +1', 13),
    back = Rudianos.tank
}
...
sets.midcast.SIRDPhalanx = {
    main = createEquipment("Sakpata's Sword"),
    sub = createEquipment("Priwen", 0, { 'HP+50', 'Mag. Evasion+50', 'Damage Taken -3%' }),
    ammo = createEquipment("Staunch Tathlum +1"),
    head = createEquipment("Yorium Barbuta", 0, { 'Spell interruption rate down -9%', 'Phalanx +3' }),
    body = createEquipment("Yorium Cuirass", 0, { 'Spell interruption rate down -10%', 'Phalanx +3' }),
    ...
    right_ring = createEquipment("Defending Ring"),
    back = createEquipment("Weard Mantle", 0, { 'VIT+4', 'Phalanx +5' })
}
