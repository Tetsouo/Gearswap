...
local _, UIConfig = pcall(require, 'Kaories/config/UI_CONFIG')
UIConfig = UIConfig or {
    init_delay = 5.0
}

-- Load region configuration (must load before message system for color codes)
local _, RegionConfig = pcall(require, 'Kaories/config/REGION_CONFIG')
...
local UIConfig = ConfigLoader.load_ui_config('Kaories', 'WAR')
...
function get_sets()
    ...
    _G.WARTPConfig = require('Kaories/config/war/WAR_TP_CONFIG')
...
function user_setup()
    ...
    -- ==========================================================================
    local WARStates = require('Kaories/config/war/WAR_STATES')
    WARStates.configure()
    ...
    -- KEYBINDS LOADING
    -- ==========================================================================
    local kb_success, keybinds = pcall(require, 'Kaories/config/war/WAR_KEYBINDS')
