...
local UIConfig = ConfigLoader.load_ui_config('Kaories', 'THF')
...
function get_sets()
    ...
    _G.THFTPCONFIG = require('Kaories/config/thf/THF_TP_CONFIG')
...
function user_setup()
    ...
    local THFStates = require('Kaories/config/thf/THF_STATES')
    THFStates.configure()
    ...
    if is_initial_setup then
        ...
        local success, keybinds = pcall(require, 'Kaories/config/thf/THF_KEYBINDS')
