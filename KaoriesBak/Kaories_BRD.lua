...
local ui_config_success, UIConfig = pcall(require, 'Kaories/config/UI_CONFIG')
...
local UIConfig = ConfigLoader.load_ui_config('Kaories', 'BRD')
...
function get_sets()
    ...
    _G.BRDTPConfig = require('Kaories/config/brd/BRD_TP_CONFIG')
    _G.BRDSongConfig = require('Kaories/config/brd/BRD_SONG_CONFIG')
    _G.BRDTimingConfig = require('Kaories/config/brd/BRD_TIMING_CONFIG')
...
function user_setup()
    ...
    local BRDStates = require('Kaories/config/brd/BRD_STATES')
    BRDStates.configure()

    if is_initial_setup then
        -- KEYBIND LOADING
        local success, keybinds = pcall(require, 'Kaories/config/brd/BRD_KEYBINDS')
