...
local UIConfig = ConfigLoader.load_ui_config('Gabvanstronger', 'BRD')
...
function get_sets()
    ...
    _G.BRDTPConfig = require('Gabvanstronger/config/brd/BRD_TP_CONFIG')
    _G.BRDSongConfig = require('Gabvanstronger/config/brd/BRD_SONG_CONFIG')
    _G.BRDTimingConfig = require('Gabvanstronger/config/brd/BRD_TIMING_CONFIG')
...
function user_setup()
    ...
    local BRDStates = require('Gabvanstronger/config/brd/BRD_STATES')
    BRDStates.configure()

    if is_initial_setup then
        -- KEYBIND LOADING
        local success, keybinds = pcall(require, 'Gabvanstronger/config/brd/BRD_KEYBINDS')
