...
local UIConfig = ConfigLoader.load_ui_config('Gabvanstronger', 'DRK')
...
function get_sets()
    ...
    _G.DRKTPCONFIG = require('Gabvanstronger/config/drk/DRK_TP_CONFIG')
...
function user_setup()
    ...
    local DRKStates = require('Gabvanstronger/config/drk/DRK_STATES')
    DRKStates.configure()
    ...
    if is_initial_setup then
        -- Load keybinds
        local success, keybinds = pcall(require, 'Gabvanstronger/config/drk/DRK_KEYBINDS')
