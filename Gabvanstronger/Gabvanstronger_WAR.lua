...
local _, RegionConfig = pcall(require, 'Gabvanstronger/config/REGION_CONFIG')
...
local UIConfig = ConfigLoader.load_ui_config('Gabvanstronger', 'WAR')
...
function get_sets()
    ...
    _G.WARTPConfig = require('Gabvanstronger/config/war/WAR_TP_CONFIG')
...
function user_setup()
    ...
    -- ==========================================================================
    local WARStates = require('Gabvanstronger/config/war/WAR_STATES')
    WARStates.configure()
    ...
    -- KEYBINDS LOADING
    -- ==========================================================================
    local kb_success, keybinds = pcall(require, 'Gabvanstronger/config/war/WAR_KEYBINDS')
