---============================================================================
--- RUN Blue Magic Configuration - Dynamic AOE Spell Detection
---============================================================================
...
---============================================================================
--- All AOE Blue Magic spells for RUN tank enmity generation (Level 1-60)
...
---
--- Note: Yawn (Level 64) impossible for RUN/BLU subjob (cap 60 with Master Level 50)
---============================================================================

RUN_BLU_MAGIC.aoe_spell_database = {{
    name = 'Geist Wall',
    enmity = 640,
    recast = 30,
    priority = 21.33
...
RUN_BLU_MAGIC.manual_rotation = {'Geist Wall', -- 21.33 enmity/sec (30s recast) - BEST
...
local function build_dynamic_rotation()
    ...
    local sorted_spells = {}
    for _, spell in ipairs(RUN_BLU_MAGIC.aoe_spell_database) do
...
function RUN_BLU_MAGIC.get_rotation()
...
function RUN_BLU_MAGIC.get_info()
    local rotation = RUN_BLU_MAGIC.get_rotation()
    local is_dynamic = RUN_BLU_MAGIC.is_dynamic()
