...
local UIConfig = ConfigLoader.load_ui_config('Gabvanstronger', 'WHM')
...
function get_sets()
    ...
    _G.WHMTPConfig = require('Gabvanstronger/config/whm/WHM_TP_CONFIG')
...
function user_setup()
    ...
    local WHMStates = require('Gabvanstronger/config/whm/WHM_STATES')
    WHMStates.configure()
    ...
    if is_initial_setup then
        -- Load keybinds
        local success, keybinds = pcall(require, 'Gabvanstronger/config/whm/WHM_KEYBINDS')
